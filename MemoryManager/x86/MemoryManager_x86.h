...
#define KERNEL_VA_END			((uint32_t)0 - KERNEL_PAGE_SIZE)
// temp
#define KERNEL_ELF_LOADER_INIT_BASE (KERNEL_BSS_SECTION_BEGIN)
#define KERNEL_FS_DRIVER_INIT_BASE	(KERNEL_BSS_SECTION_BEGIN + KERNEL_ELF_LOADER_SIZE_X86)
#define KERNEL_ELF_LOADER_PHYS_BASE (KERNEL_PHYS_BASE_X86 + ALIGN_TO_UP(KERNEL_SIZE_X86, KERNEL_PAGE_SIZE_X86))
#define KERNEL_FS_DRIVER_PHYS_BASE	(KERNEL_ELF_LOADER_PHYS_BASE + ALIGN_TO_UP(KERNEL_ELF_LOADER_SIZE_X86, KERNEL_PAGE_SIZE_X86))

#define KERNEL_ELF_LOADER_BASE	(KERNEL_VA_END - ALIGN_TO_UP(KERNEL_ELF_LOADER_SIZE_X86, KERNEL_PAGE_SIZE_X86))
#define KERNEL_FS_DRIVER_BASE	(KERNEL_ELF_LOADER_BASE - ALIGN_TO_UP(KERNEL_FS_DRIVER_SIZE_X86, KERNEL_PAGE_SIZE_X86))

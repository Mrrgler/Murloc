...
#define USE_LOCKS 2
#define INSECURE 0
#define ABORT LogCritical("Some error occured in dlmalloc.")
#define DEBUG 1
#define MALLOC_FAILURE_ACTION  LogCritical("kmalloc failure "__FILE__":"make_mrgl(__LINE__))// none
#define HAVE_MORECORE 1
#define MORECORE ksbrk
#define HAVE_MMAP 0
#define HAVE_MREMAP 0
#define USE_BUILTIN_FFS 1
#define malloc_getpagesize KERNEL_PAGE_SIZE_X86
...
#define LACKS_TIME_H
//#define DEFAULT_GRANULARITY KERNEL_PAGE_SIZE_X86
#define DEFAULT_TRIM_THRESHOLD 1024 * 1024 // 1Mb
